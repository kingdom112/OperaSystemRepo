...
public class JMutiLineText : Text
{ 
    ...
    protected override void OnPopulateMesh(VertexHelper toFill)
    {
        ...
        if (roundingOffset != Vector2.zero)
        {
            ...
            for (int i = 0; i < vertCount; ++i)
            {
                ...
                if (lineNum > -1 && lineNum < yPosList.Count)
                {
                    ...
                    m_TempVerts[tempVertsIndex].position.x += drawOffset_X;
                    m_TempVerts[tempVertsIndex].position.y += (fontSize + lineSpacing * 2) * lineNum - (drawOffset_Y + yPosList[lineNum]);
