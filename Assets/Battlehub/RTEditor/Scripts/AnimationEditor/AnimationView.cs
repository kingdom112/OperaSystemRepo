...
namespace Battlehub.RTEditor
{
    public class AnimationView : RuntimeWindow
    {
        ...
        {
            Debug.Log("OnPropertyValueChanged");
        ...
        {
            Debug.Log("OnPreviewToggleValueChanged");
            if (m_target != null)
            {
        ...
        {
            Debug.Log("OnRecordToggleValueChanged");
            if (value)
            {
                Debug.Log("Recording...");
            }
        ...
        {
            Debug.Log("OnPlayToggleValueChanged");
            if (Target != null)
            {
        ...
        {
            Debug.Log("OnAddKeyframeButtonClick");
            ...
            if (properties.Length == 0)
            {
                ...
                {
                    Debug.Log("!!! " + properties[i].PropertyName);
                }
            }
            else
            {
        ...
        {
            Debug.Log("OnDopesheetToggleValueChanged");
