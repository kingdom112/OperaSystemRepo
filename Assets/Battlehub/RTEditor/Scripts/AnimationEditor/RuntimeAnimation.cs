...
{
    public class RuntimeAnimationClip 
    {
        public string name = "noName"; 
        private readonly List<RuntimeAnimationProperty> m_properties;
        private AnimationClip m_clip = new AnimationClip();
        ...
        private void SetCurve(RuntimeAnimationProperty property)
        {
            ...
            {
                Debug.Log("set curve: componentType: " + componentType + " , AnimationPropertyPath: " + property.AnimationPropertyPath + "  ");
    ...
    public class RuntimeAnimation : MonoBehaviour
    {
        ...
        public float NormalizedTime
        {
            ...
            set
            {
                ...
                if(HasRAListener)
                {
                    gameObject.SendMessage("OnRuntimeAnimationNormalizedTimeChanged");
                } 
            }
        }

        RuntimeAnimationListener raListener1 = null;
        private void Update()
        {
            if(m_isPlaying)
            {
        ...
        private bool HasRAListener
        {
            get
            {
                ...
                {
                    raListener1 = gameObject.GetComponent<RuntimeAnimationListener>();
                    if (raListener1 == null)
                    {
                        return false;
                    }
        ...
        public void MySetNormalizedTime(float time1)
        {
            if (!m_animation.isPlaying)
            {
                Refresh();
