...
namespace Battlehub.RTEditor
{
    public class Dopesheet : MonoBehaviour
    {
        public class DsAnimationClip
        {
            ...
            {
                Debug.Log("DsAnimationClip.AddRow");
                DsRow row = new DsRow();
            ...
            {
                Debug.Log("Dopesheet.DsAnimationClip.Expand: " + row + " , " + count);
            ...
            {
                Debug.Log("Dopesheet.DsAnimationClip.Collapse: " + row + " , " + count);
                for (int i = row + 1; i <= row + count; ++i)
                {
            ...
            {
                Debug.Log("Dopesheet.DsAnimationClip.UpdateRowIndexes ");
