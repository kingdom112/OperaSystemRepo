...
namespace Battlehub.RTEditor
{
    public class AnimationComponentView : MonoBehaviour
    {
        ...
        public RuntimeAnimationProperty Item
        {
            ...
            set
            {
                ...
                if (m_item != null)
                {
                    ...
                    if (m_label != null)
                    {
                        Debug.Log("set, ComponentDisplayName: " + m_item.ComponentDisplayName+ " , PropertyDisplayName: "+ m_item.PropertyDisplayName+" , "+ m_item.PropertyName);
        ...
        {
           if(Item.PropertyName == "localEuler")
            {
                Item.PropertyName = "localRotation";
                Item.AnimationPropertyName = "m_LocalRotation"; 
            }
