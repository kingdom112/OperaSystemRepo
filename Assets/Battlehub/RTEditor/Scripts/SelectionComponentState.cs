...
namespace Battlehub.RTEditor
{
    ...
    public class SelectionComponentState : RTEComponent, ISelectionComponentState
    {
        ...
        {
            Debug.Log("IsBoxSelectionEnabled");
        ...
        {
            Debug.Log("IsPositionHandleEnabled");
        ...
        {
            Debug.Log("IsRotationHandleEnabled");
        ...
        {
            Debug.Log("IsScaleHandleEnabled");
