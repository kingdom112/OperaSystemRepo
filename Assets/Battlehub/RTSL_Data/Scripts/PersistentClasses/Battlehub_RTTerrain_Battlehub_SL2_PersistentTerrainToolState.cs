...
{
    [ProtoContract]
    public partial class PersistentTerrainToolState : PersistentMonoBehaviour
    {
        [ProtoMember(256)]
        public TerrainSelectionHandlesTool.Interpolation Interpolation;
