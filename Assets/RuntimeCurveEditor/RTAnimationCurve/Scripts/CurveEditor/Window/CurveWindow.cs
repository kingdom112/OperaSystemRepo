...
namespace RuntimeCurveEditor
{
    ...
    { 
        public bool canResizeWindow = true;
        ...
        void Start() {
            ...
            WindowClosed = windowClosed;//in case windowClosed property has been set before Start(),mWindowClosed will be redundant
        ...
        void UpdateScreenWindowGrid() {
            ...
            PostRenderBehaviour.HALF_SCREEN = new Vector2(canvas.rect.width * 0.5f, canvas.rect.height * 0.5f);
            PostRenderBehaviour.SCALE_VECTOR = new Vector2(2 * PostRenderBehaviour.HALF_SCREEN.x / Screen.width, 2 * PostRenderBehaviour.HALF_SCREEN.y / Screen.height);
            UpdateWindowAndGrid();
        }
        ...
        /// 更新绘制
        /// </summary>
        public void CallUpdateWindowAndGrid()
        {
            headerPanel.sizeDelta = new Vector2(panel.sizeDelta.x, headerPanel.sizeDelta.y);
            UpdateWindowAndGrid();
        }
